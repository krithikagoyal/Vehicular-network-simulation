...
// ./waf --run "scratch/ns2-mobility-trace --traceFile=scratch/mobility2_57_a.tcl --nodeNum=57 --duration=3600.0 --logFile=ns2-mob.log"
// ./waf --run "scratch/ns2-mobility-trace --traceFile=scratch/mobility2_57_r.tcl --nodeNum=57 --duration=3600.0 --logFile=ns2-mob.log"
// ./waf --run "scratch/ns2-mobility-trace --traceFile=scratch/mobility0_121_a.tcl --nodeNum=121 --duration=3600.0 --logFile=ns2-mob.log"
// ./waf --run "scratch/ns2-mobility-trace --traceFile=scratch/mobility0_121_r.tcl --nodeNum=121 --duration=3600.0 --logFile=ns2-mob.log"
// ./waf --run "scratch/ns2-mobility-trace --traceFile=scratch/mobility4_349_a.tcl --nodeNum=349 --duration=3600.0 --logFile=ns2-mob.log"
// ./waf --run "scratch/ns2-mobility-trace --traceFile=scratch/mobility4_349_r.tcl --nodeNum=349 --duration=3600.0 --logFile=ns2-mob.log"
...
uint32_t patientNode = 195;
double emergencyOccurenceTime = 30.0;
...
// For RSU
// mobility 2: 3, 47, 51, 35, 20
// mobility 0: 107, 68
// mobility 4: 145, 209, 130, 240, 169, 80, 60, 199
std::vector<int> ids = {145, 209, 130, 240, 169, 80, 60, 199};

// RSU positions
// mobility 2: 199.85, 231.31
// mobility 0: 849.06, 669.23
// mobility 4: 145.08, 311.02
double rsuPosX = 145.08, rsuPosY = 311.02;
...
void checkValue(Ptr<Socket> patientSocket, int32_t packetSize, int32_t numPackets, Time interPacketInterval) {
    if (getline(MyReadFile, myText)) {
        if (myText[0] != 'N') {
            GenerateTraffic(patientSocket, packetSize, numPackets, interPacketInterval);
        }
    }

    Simulator::Schedule(Seconds(1), &checkValue, patientSocket, packetSize, numPackets, interPacketInterval);
}
...
int main(int argc, char *argv[]) {
    ...
    MyReadFile.open("scratch/alert.txt");
